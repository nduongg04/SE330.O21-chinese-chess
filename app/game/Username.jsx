    ...
    return (
        <div className="username-container">
            <div className={`username ${isPlayer1Turn ? 'red' : 'black'}`}>
                ...
                {player1Name}
                {isRed && <img src="/assets/piece_assets/RGeneral.png" className="general-icon" alt="Red General" />}
            </div>
            <div className={`username ${isPlayer2Turn ? 'red' : 'black'}`}>
                {isRed && <img src="/assets/piece_assets/BGeneral.png" className="general-icon" alt="Black General" />}
                {player2Name}
